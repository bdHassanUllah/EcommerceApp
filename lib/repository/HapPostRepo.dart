...
class MarketplaceRepository {
  ...
  Future<List<dynamic>> fetchMarketplacePosts() => mktApiService.getData('/marketplaces/');
}
...
class BusinessRepository {
  ...
  Future<List<dynamic>> fetchBusinessPosts() => businessApi.getBusinessData('/businesses');
}