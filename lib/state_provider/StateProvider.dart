...
final marketplaceRepositoryProvider = Provider<MarketplaceRepository>((ref) {
  return MarketplaceRepository(MarketplaceUrl(baseUrl: "https://ecommerce.com.pk/wp-json/api/v1"));
});

// Blog Repository Provider
final blogRepositoryProvider = Provider<BlogsRepository>((ref) {
  return BlogsRepository(Blogsapi(blogBaseUrl: "https://ecommerce.com.pk/wp-json/api/v1"));
});

// Business Repository Provider
final businessRepositoryProvider = Provider<BusinessRepository>((ref) {
  return BusinessRepository(BusinessApi(BusinessApiUrl: "https://ecommerce.com.pk/wp-json/api/v1"));
});
